...
/**
 * @brief      Wrapper for the official FBFUSE pipeline
 */
class Pipeline
{
public:
...
public:
     ...
     * @param      cb_writer               DADA write client for output coherent beam data buffer
     * @param      ib_writer               DADA write client for output incoherent beam data buffer
